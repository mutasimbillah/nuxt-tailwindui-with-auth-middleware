                    ...
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                      ...
                      <img class="inline-block h-10 w-10 rounded-full"
                        ...
                        alt="" />
                                        ...
                                        <div class="ml-3">
                                            <p class="text-base font-medium text-white">Mutasim Billah</p>
            ...
            <div class="flex min-h-0 flex-1 flex-col bg-gray-800">
                ...
                <img class="inline-block h-9 w-9 rounded-full"
                  ...
                  alt="" />
                            ...
                            <div class="ml-3">
                                <p class="text-sm font-medium text-white">Mutasim Billah</p>
                                <p class="text-xs font-medium text-gray-300 group-hover:text-gray-200">01521435356</p>
                            </div>
                        </div>
                    </a>
                </div>
